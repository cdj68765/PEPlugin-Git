...
namespace DotNetDetour.DetourWays
{
    ...
    {
        private object oldPointer;
        private IntPtr destAdr;
        private IntPtr srcAdr;
        ...
        void IDetour.Patch(MethodBase rawMethod, MethodBase hookMethod, MethodBase originalMethod)
        {
            Patch((MethodInfo)rawMethod, (MethodInfo)hookMethod);
        }
